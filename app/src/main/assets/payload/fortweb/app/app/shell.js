import { homeHref, identifiersHref, kfHomeHref, kfIdentifiersHref, remotesHref, kfWitnessesHref, kfWatchersHref, settingsHref, } from "./router.js";
...
function sidebarNav(route, vaultId, state) {
    if (route.navMode === "plugin") {
        return pluginSidebarNav(route, vaultId, state?.lastCoreRoutes?.[vaultId] || identifiersHref(vaultId));
    }
