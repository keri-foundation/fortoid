...
export function renderRemoteDetailPage({ vault, remote }) {
    return {
        ...
        render(container) {
            ...
            stateGrid.append(copyableDetailItem("Prefix", remote.prefix), copyableDetailItem("Last Event SAID", remote.lastEventDigest), copyableDetailItem("OOBI", remote.oobi), detailItem("Key State Updated", remote.keystateUpdatedAt ? formatDateLabel(remote.keystateUpdatedAt) : "Not recorded"));
            ...
            metadataGrid.append(detailItem("Alias", remote.alias), detailItem("Organization", remote.org), detailItem("Company", remote.company), detailItem("Note", remote.note));
            ...
            connectivityGrid.append(detailItem("Mailboxes", remote.mailboxes.length ? remote.mailboxes.join(", ") : "Not recorded"), detailItem("KEL Events", String(remote.kelEvents)), detailItem("Slice Status", "Roles and mailboxes are read-only in this remotes slice."));
