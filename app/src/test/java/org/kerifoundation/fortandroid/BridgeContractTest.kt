    ...
    fun workerResultTypesMatchSharedContract() {
        assertEquals(
            setOf(
                ...
                BridgeContract.WORKER_RES_DB_PUT_RESULT,
                BridgeContract.WORKER_RES_DB_GET_RESULT,
                BridgeContract.WORKER_RES_DB_DEL_RESULT,
                BridgeContract.WORKER_RES_DB_LIST_RESULT,
        ...
        assertEquals(
            setOf(
                ...
                BridgeContract.WORKER_CMD_DB_PUT,
                BridgeContract.WORKER_CMD_DB_GET,
                BridgeContract.WORKER_CMD_DB_DEL,
                BridgeContract.WORKER_CMD_DB_LIST,
            ),
